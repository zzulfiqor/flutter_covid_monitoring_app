...
//
//     final covidWorldwideModel = covidWorldwideModelFromJson(jsonString);

import 'dart:convert';

CovidWorldwideModel covidWorldwideModelFromJson(String str) => CovidWorldwideModel.fromJson(json.decode(str));

String covidWorldwideModelToJson(CovidWorldwideModel data) => json.encode(data.toJson());

class CovidWorldwideModel {
    CovidWorldwideModel({
        this.confirmed,
        this.recovered,
        this.deaths,
    ...
    factory CovidWorldwideModel.fromJson(Map<String, dynamic> json) => CovidWorldwideModel(
